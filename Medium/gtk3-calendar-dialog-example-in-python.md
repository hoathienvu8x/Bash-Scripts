---
title: GTK3 Calendar dialog example in Python
link: https://www.darkartistry.com/2018/07/gtk3-calendar-dialog-example-in-python/
author: Dark Artistry
---

Open a calendar in a Gtk window and get the user’s selected values in the
main App class.
